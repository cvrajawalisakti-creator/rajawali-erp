            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="Finished Good"
                            {{ old('item_type') == 'Finished Good' ? 'selected' : '' }}>
                            Finished Good
                        </option>

                        <option value="Semi Finished"
                            {{ old('item_type') == 'Semi Finished' ? 'selected' : '' }}>
                            Semi Finished
                        </option>

                        <option value="Raw Material"
                            {{ old('item_type') == 'Raw Material' ? 'selected' : '' }}>
                            Raw Material
                        </option>

                        <option value="Component"
                            {{ old('item_type') == 'Component' ? 'selected' : '' }}>
                            Component
                        </option>

                        <option value="Purchased Part"
                            {{ old('item_type') == 'Purchased Part' ? 'selected' : '' }}>
                            Purchased Part
                        </option>
                        ...
                        <option value="Customer Material"
                            {{ old('item_type') == 'Customer Material' ? 'selected' : '' }}>
                            Customer Material
                        </option>
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="GRAM"
                            {{ old('unit') == 'GRAM' ? 'selected' : '' }}>
                            GRAM
                        </option>

                        <option value="LITER"
                            {{ old('unit') == 'LITER' ? 'selected' : '' }}>
                            LITER
                        </option>
                        ...
                        <option value="MM"
                            {{ old('unit') == 'MM' ? 'selected' : '' }}>
                            MM
                        </option>

                        <option value="CM"
                            {{ old('unit') == 'CM' ? 'selected' : '' }}>
                            CM
                        </option>

                        <option value="BATANG"
                            {{ old('unit') == 'BATANG' ? 'selected' : '' }}>
                            BATANG
                        </option>
                        ...
                        <option value="PACK"
                            {{ old('unit') == 'PACK' ? 'selected' : '' }}>
                            PACK
                        </option>

                        <option value="LOT"
                            {{ old('unit') == 'LOT' ? 'selected' : '' }}>
                            LOT
                        </option>
